    ...
    <main class="main">
      <header class="topbar">
        <div class="left">
          ...
          <div class="crumb" id="crumb">Transactions / Add Expense</div>
        </div>
      </header>
      ...
      <section class="content">
        <div class="card" style="max-width:720px;">
          ...
          <label>Note</label>
          <input id="expNote" placeholder="Burger">

          <label>Amount</label>
          <input id="expAmount" type="number" step="0.01" placeholder="7.50">

          <div class="row" style="margin-top:12px;">
            <button class="btn" id="addExpenseBtn">Save expense</button>
