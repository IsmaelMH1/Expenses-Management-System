    ...
    <main class="main">
      <header class="topbar">
        <div class="left">
          ...
          <div class="crumb">Debts / Payment</div>
        </div>
      </header>
      ...
      <section class="content">
        <div class="card" style="max-width:720px;">
          ...
          <label>Amount</label>
          <input id="payAmount" type="number" step="0.01" placeholder="50.00">

          <label>Note</label>
          <input id="payNote" placeholder="Paid part of card">

          <div class="row" style="margin-top:12px;">
            <button class="btn" id="addPayBtn">Save payment</button>
